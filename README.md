...
```
npm create cloudflare@latest -- --template=cloudflare/templates/fancy-feather-5310
```

## Preview Deployment

A live public deployment of this template is available at [https://fancy-feather-5310.templates.workers.dev](https://fancy-feather-5310.templates.workers.dev)
